...
class EntityConsistencyTool(BaseFraudDetectionTool):
    ...
    @property
    def name(self) -> str:
        return "validate_entity_consistency"

    @property
    def description(self) -> str:
        return """Validate that entity information (suppliers, buyers, shippers) is consistent across documents.
...
class ProductDescriptionTool(BaseFraudDetectionTool):
    ...
    @property
    def name(self) -> str:
        return "validate_product_descriptions"

    @property
    def description(self) -> str:
        return """Validate that product descriptions are consistent across documents.
...
class ValueConsistencyTool(BaseFraudDetectionTool):
    ...
    @property
    def name(self) -> str:
        return "validate_value_consistency"

    @property
    def description(self) -> str:
        return """Validate that declared values are consistent across documents.
...
class GeographicConsistencyTool(BaseFraudDetectionTool):
    ...
    @property
    def name(self) -> str:
        return "validate_geographic_consistency"

    @property
    def description(self) -> str:
        return """Validate geographic consistency to detect origin manipulation and transshipment fraud.
