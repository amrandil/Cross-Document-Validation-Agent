    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center space-x-6">
              <div>
                <Image src="/logo.png" alt="MicroClear Logo" width={200} height={60} className="h-14 w-auto" />
              </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <Activity className={`w-4 h-4 mr-2 ${healthLoading ? "animate-spin" : ""}`} />
                Test API
              </Button>
              {apiStatus === "connected" && (
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Multi-Document Fraud Detection Agent</h1>
          <p className="text-lg text-microclear-gray max-w-3xl mx-auto">
            Advanced AI-powered analysis for customs fraud detection with intelligent pattern recognition
          </p>
        </div>
          ...
          <div className="lg:col-span-3">
            <Tabs defaultValue="upload" className="w-full">
              <TabsList className="grid w-full grid-cols-3 bg-white border border-gray-200 rounded-lg p-1">
                <TabsTrigger
                  value="upload"
                  className="rounded-md data-[state=active]:bg-microclear-blue data-[state=active]:text-white"
                >
                  Document Upload
                </TabsTrigger>
                <TabsTrigger
